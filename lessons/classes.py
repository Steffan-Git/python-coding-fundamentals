# OOP:
# - abstraction: not seeing the code.
# - encapsulation: privacy + safety 
# - inheritance: parent-child inheritance. 
# - polymorphism: overridding(python)/overloading behaviour. 


# gives us new structure, object creation (custom), state, behaviour(methods). 
...
# class Students:
#     def __init__(self, first_name, second_name, age=10):
...
# student1 = Students("a", "b", 20)
# # print(student1.full_name)
# print(student1.full_name())
# print(Students.full_name(student1))
...
# def outside(self):
#     return f"{self.first_name} was the caller of this method"
...
class Students:
    ...
    def __init__(self, first_name, second_name, age=10):
        ...
        Students.__number_of_students += 1
    ...
    def get_num_of_students(cls):
        return cls.__number_of_students
...
print(Students.get_num_of_students())
print(Students._Students__number_of_students)
...
class Animal:
    ...
    def demo(self):
        print(f"{self.name} called this!")

    def __str__(self):
        return f"({self.name}, {self.species}, {self.__dict__}, {self.__class__.__name__})"
...
class Cat(Animal):
    ...
    # @override
    def demo(self):
        print(f"{self.name} called this from its own class!")
